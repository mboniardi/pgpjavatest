...
public class Main {
    ...
    public void testApplication2() {
        ...
        String passphrase = "Viaggiare99";
        System.out.println("======= LOADING KEYS ============");
        PGPFactory pgpFactory = PGPFactory.getInstance();
        pgpFactory.loadPrivKeyFromStrings(privkeyString, passphrase);
        pgpFactory.loadPubKeyFromStrings(pubkeyString);
        //pgpFactory.loadOwnerKeysFromStrings(pubkeyString, privkeyString, "Viaggiare99");
